...
ax1.plot(rho,rho_density,linestyle="--",label=r"$\rho(r)$ ; $a=0$")
ax1.plot(rho_a0043,rho_density_a0043,linestyle="--",label=r"$\rho(r)$ ; $a=0.0043$")
ax1.legend()
ax1.set_xlabel(r"$r$")
...
ax2.plot(x,x_density,linestyle="--",label=r"$f_x(x)$ ; $a=0$")
ax2.plot(x_a0043,x_density_a0043,linestyle="--",label=r"$f_x(x)$ ; $a=0.0043$")
ax2.legend()
ax2.set_xlabel(r"$x$")
